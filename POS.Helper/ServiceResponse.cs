...
namespace POS.Helper
{
    public class ServiceResponse<T>
    {
        ...
        /// <summary>
        /// Returns the success with a message.
        /// </summary>
        /// <returns></returns>
        public static ServiceResponse<T> ReturnSuccessMessage(string message)
        {
            return new ServiceResponse<T>(200, new List<string> { message });
        }
