...
CREATE TABLE `Units` (
    ...
    CONSTRAINT `FK_Units_Users_CreatedBy` FOREIGN KEY (`CreatedBy`) REFERENCES `Users` (`Id`) ON DELETE RESTRICT
) CHARACTER SET=utf8mb4;
...
CREATE TABLE `InventoryHistories` (
    ...
    `PreviousTotalStock` bigint NOT NULL,
...
CREATE INDEX `IX_Units_CreatedBy` ON `Units` (`CreatedBy`);
...
VALUES ('20220602152247_Initial', '6.0.5');
...
INSERT `Units` (`Id`, `Name`, `CreatedDate`, `CreatedBy`, `ModifiedDate`, `ModifiedBy`, `DeletedDate`, `DeletedBy`, `IsDeleted`) VALUES (N'e9e5b90d-30a2-4af5-ac95-56710734c84b', N'Box', CAST(N'2022-05-21T13:01:25.8097997' AS DateTime), N'4b352b37-332a-40c6-ab05-e38fcf109719', CAST(N'2022-05-21T13:01:25.8098030' AS DateTime), N'4b352b37-332a-40c6-ab05-e38fcf109719', NULL, NULL, 0);
INSERT `Units` (`Id`, `Name`, `CreatedDate`, `CreatedBy`, `ModifiedDate`, `ModifiedBy`, `DeletedDate`, `DeletedBy`, `IsDeleted`) VALUES (N'907c5dab-b5b1-460f-b46d-ab724fa2a4ae', N'Kg', CAST(N'2022-05-21T13:01:45.6687857' AS DateTime), N'4b352b37-332a-40c6-ab05-e38fcf109719', CAST(N'2022-05-21T13:01:45.6687875' AS DateTime), N'4b352b37-332a-40c6-ab05-e38fcf109719', NULL, NULL, 0);
INSERT `Units` (`Id`, `Name`, `CreatedDate`, `CreatedBy`, `ModifiedDate`, `ModifiedBy`, `DeletedDate`, `DeletedBy`, `IsDeleted`) VALUES (N'4f0a0258-0a2e-4155-8e6a-d753db215fbd', N'Piece', CAST(N'2022-05-21T13:01:37.3001887' AS DateTime), N'4b352b37-332a-40c6-ab05-e38fcf109719', CAST(N'2022-05-21T13:01:37.3001902' AS DateTime), N'4b352b37-332a-40c6-ab05-e38fcf109719', NULL, NULL, 0);
...
INSERT `Roles` (`Id`, `IsDeleted`, `CreatedDate`, `CreatedBy`, `ModifiedDate`, `ModifiedBy`, `DeletedDate`, `DeletedBy`, `Name`, `NormalizedName`, `ConcurrencyStamp`) VALUES (N'ff635a8f-4bb3-4d70-a3ed-c7749030696c', 0, CAST(N'2022-05-21T12:56:58.8525276' AS DateTime), N'4b352b37-332a-40c6-ab05-e38fcf109719', CAST(N'2022-05-21T12:56:58.8600000' AS DateTime), N'4b352b37-332a-40c6-ab05-e38fcf109719', NULL, NULL, N'Employee', N'Employee', N'aef4f8d9-266f-4d14-8afc-6012296ff054');
INSERT `Roles` (`Id`, `IsDeleted`, `CreatedDate`, `CreatedBy`, `ModifiedDate`, `ModifiedBy`, `DeletedDate`, `DeletedBy`, `Name`, `NormalizedName`, `ConcurrencyStamp`) VALUES (N'f8b6ace9-a625-4397-bdf8-f34060dbd8e4', 0, CAST(N'2022-05-21T12:55:58.2030965' AS DateTime), N'4b352b37-332a-40c6-ab05-e38fcf109719', CAST(N'2022-05-21T12:55:58.3100000' AS DateTime), N'4b352b37-332a-40c6-ab05-e38fcf109719', NULL, NULL, N'Super Admin', N'Super Admin', N'8671170d-fe29-4492-9378-58afd0a078e4');
...
INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20220602152424_Initial_Data', '6.0.5');
