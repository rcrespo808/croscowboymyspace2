...
{
    public class DeleteCityCommandHandler : IRequestHandler<DeleteEventosCommand, ServiceResponse<bool>>
    {
        ...
        public async Task<ServiceResponse<bool>> Handle(DeleteEventosCommand request, CancellationToken cancellationToken)
        {
