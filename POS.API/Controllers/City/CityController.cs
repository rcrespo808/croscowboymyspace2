...
namespace POS.API.Controllers.City
{
    ...
    public class CityController : BaseController
    {
        ...
        {
            var getAllCityQuery = new GetAllEventosQuery
            {
        ...
        //[HttpPost]
        //[ClaimCheck("SETT_MANAGE_CITY")]
        //public async Task<IActionResult> AddCity([FromBody] AddEventosCommand addCityCommand)
        //{
        ...
        {
            var deleteCityCommand = new DeleteEventosCommand { Id = id };
