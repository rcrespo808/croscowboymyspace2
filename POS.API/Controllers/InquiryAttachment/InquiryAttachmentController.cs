...
namespace POS.API.Controllers.InquiryAttachment
{
    ...
    public class InquiryAttachmentController : BaseController
    {
        ...
        public async Task<IActionResult> DownloadFile(Guid id)
        {
            ...
            string contentRootPath = System.IO.Path.Combine(Directory.GetCurrentDirectory(), "wwwroot"); //_webHostEnvironment.WebRootPath;
