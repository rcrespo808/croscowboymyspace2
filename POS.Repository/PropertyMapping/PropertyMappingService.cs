...
namespace POS.Repository
{
    public class PropertyMappingService : IPropertyMappingService
    {
       ...
       new Dictionary<string, PropertyMappingValue>(StringComparer.OrdinalIgnoreCase)
       {
        ...
        private Dictionary<string, PropertyMappingValue> _nosotrosPropertyMapping =
            new Dictionary<string, PropertyMappingValue>(StringComparer.OrdinalIgnoreCase)
            {
                    { "Id", new PropertyMappingValue(new List<string>() { "Id" } ) },
            };

        private Dictionary<string, PropertyMappingValue> _informacionInteresPropertyMapping =
          new Dictionary<string, PropertyMappingValue>(StringComparer.OrdinalIgnoreCase)
          {
                           { "Id", new PropertyMappingValue(new List<string>() { "Id" } ) },
                           { "Tipo", new PropertyMappingValue(new List<string>() { "Tipo" } )},
                           { "Titulo", new PropertyMappingValue(new List<string>() { "Titulo" } )},
                           { "Descripcion", new PropertyMappingValue(new List<string>() { "Descripcion" } )},
                           { "Contenido", new PropertyMappingValue(new List<string>() { "Contenido" } )},
                           { "Documento", new PropertyMappingValue(new List<string>() { "Documento" } )},
                           { "Fecha", new PropertyMappingValue(new List<string>() { "Fecha" } )},
                           { "CreatedDate", new PropertyMappingValue(new List<string>() { "CreatedDate" }, true )}
          };

        private Dictionary<string, PropertyMappingValue> _eventosPropertyMapping =
          new Dictionary<string, PropertyMappingValue>(StringComparer.OrdinalIgnoreCase)
          {
                           { "Id", new PropertyMappingValue(new List<string>() { "Id" } ) },
                           { "Titulo", new PropertyMappingValue(new List<string>() { "Titulo" } )},
                           { "CostoSocios", new PropertyMappingValue(new List<string>() { "CostoSocios" } )},
                           { "CostoComun", new PropertyMappingValue(new List<string>() { "CostoComun" } )},
                           { "Ubicacion", new PropertyMappingValue(new List<string>() { "Ubicacion" } )},
                           { "FechaInicial", new PropertyMappingValue(new List<string>() { "FechaInicial" } )},
                           { "FechaFinal", new PropertyMappingValue(new List<string>() { "FechaFinal" } )},
                           { "Destacado", new PropertyMappingValue(new List<string>() { "Destacado" }, true )}
          };
        ...
        public PropertyMappingService()
        {
            ...
            propertyMappings.Add(new PropertyMapping<NosotrosDto, Nosotros>(_nosotrosPropertyMapping));
            propertyMappings.Add(new PropertyMapping<InterestInformationDto, Informacioninteres>(_informacionInteresPropertyMapping));
            propertyMappings.Add(new PropertyMapping<EventosDto, Data.Entities.Lookups.Eventos>(_eventosPropertyMapping));
        }
