...
namespace POS.Repository
{
          ...
          IUserRepository
    {
        ...
        private readonly ISupplierRepository _suppliermRepository;
            ...
            ) : base(uow)
        {
            ...
            _suppliermRepository = supplierRepository;
        }

        public async Task<UserList> GetUsers(UserResource userResource)
        {
            var collectionBeforePaging = All.ApplySort(userResource.OrderBy,
        ...
        public async Task<UserAuthDto> BuildUserAuthObject(User appUser)
        {
            ...
            ret.SupplierId = appUser.SupplierId;
            ret.CustomerId = appUser.CustomerId;
            return ret;
        }

        //private async Task<SupplierDto> GetUserSupplier(User appUser)
        //{
        //    var userClaims = await  _suppliermRepository.FindBy(c => c.UserId == appUser.Id).Select(c => c.ClaimType).ToListAsync();
